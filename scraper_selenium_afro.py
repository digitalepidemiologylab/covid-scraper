...
from constants import SLEEPS, WEBSITES, SELENIUM_DOWNLOADS_AFRO, XPATHS, LOGGER_BACKUP_COUNT, BEFORE_WAIT
...
writetofile_handler = RotatingFileHandler(
    'logs/log_selenium_afro.txt', mode='a', maxBytes=5*1024*1024, 
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            selenium_websites = {
                k: v for k, v in WEBSITES.items() if k in SELENIUM_DOWNLOADS_AFRO}
