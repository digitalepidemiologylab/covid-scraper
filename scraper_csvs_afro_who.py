    ...
    while True:
        ...
        for country in CSVS_AFRO_WHO:
            ...
            if str(ps[-1]) != str(p):
                ...
                continue
            # logger.info('About to launch remove')
            remove_latest_if_csv_unchanged(*ps[-2:], country, separator, t, Csv, logger)
