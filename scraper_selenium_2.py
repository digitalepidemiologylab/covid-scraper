...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            selenium_websites = {
                k: v for k, v in WEBSITES.items() if k in SELENIUM_DOWNLOADS_2}
